                            ...
                            <form enctype="multipart/form-data" method="post" action="../Assets/ActionPages/ProductUploadAction.jsp">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                     ...
                                     <div class="col-lg-12 col-md-12 col-sm-12">
                                        <fieldset>
                                            <input  type="text" class="form-control" name="MRP" id="txt_rate"  placeholder="MRP" required="">
                                        </fieldset>
                                    </div>
                                    <div class="col-lg-12">
                                        <fieldset>
                    ...
                    <div class="col-md-6">
                        <div class="contact-form" id="tab">
                            <table>
                                ...
                                <%
                                    int i = 0;
                                    String selQryP = "select * from tbl_product p inner join tbl_subcategory sc on sc.subcategory_id=p.subcategory_id inner join tbl_category c on c.category_id=sc.category_id where shop_id='" + session.getAttribute("sid") + "'";
